...
//==============================================================================
ResponseCurveComponent::ResponseCurveComponent(EquilibriumAudioProcessor& p) :
audioProcessor(p),
...
//==============================================================================
EquilibriumAudioProcessorEditor::EquilibriumAudioProcessorEditor (EquilibriumAudioProcessor& p)
...
analyserEnabledButtonAttachment(audioProcessor.apvts, "Analyser Enabled", analyserEnabledButton)
{
    ...
    auto safePtr = juce::Component::SafePointer<EquilibriumAudioProcessorEditor>(this);
...
//==============================================================================
void EquilibriumAudioProcessorEditor::paint (juce::Graphics& g)
{
    using namespace juce;
...
void EquilibriumAudioProcessorEditor::resized()
{
...
std::vector<juce::Component*> EquilibriumAudioProcessorEditor::getComps()
{
    return
    {
        &peakFreqSlider,
